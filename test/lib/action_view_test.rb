...
module ThemesForRails
  class CommonViewHelpersTest < ViewHelpersTest
    ...
    should "provide path helpers for a given theme name" do
      ...
      assert_equal "/themes/sometheme/stylesheets/nested/style.css", theme_stylesheet_path('nested/style', "sometheme")
      assert_equal "/themes/sometheme/javascripts/app.js", theme_javascript_path('app', "sometheme")
      assert_equal "/themes/sometheme/javascripts/nested/app.js", theme_javascript_path('nested/app', "sometheme")
      assert_equal "/themes/sometheme/images/logo.png", theme_image_path('logo.png', "sometheme")
      assert_equal "/themes/sometheme/images/nested/logo.png", theme_image_path('nested/logo.png', "sometheme")      
    end
